...
void drawOverObjects(SCRIPT_CTX * THIS) OLDCALL BANKED {
    THIS;
    ...
    bkg_tile.attr.draw_over_objects = 1;
    
    set_vram_byte(bkg_tile_addr, bkg_tile._tile);
    VBK_REG = VBK_BANK_0;
}

void drawUnderObjects(SCRIPT_CTX * THIS) OLDCALL BANKED {
    THIS;
    uint8_t * bkg_tile_addr;
    union tile bkg_tile;
    //union tile win_tile;
    ...
    bkg_tile.attr.draw_over_objects = 0;
    
    set_vram_byte(bkg_tile_addr, bkg_tile._tile);
    VBK_REG = VBK_BANK_0;
}

void setBkgTileColor(SCRIPT_CTX * THIS) OLDCALL BANKED {
    THIS;
    uint8_t * bkg_tile_addr;
    union tile bkg_tile;
    //union tile win_tile;
    ...
    bkg_tile.attr.palette = pal;
    
    set_vram_byte(bkg_tile_addr, bkg_tile._tile);
    VBK_REG = VBK_BANK_0;
}

void incrementBkgTileColor(SCRIPT_CTX * THIS) OLDCALL BANKED {
    THIS;
    uint8_t * bkg_tile_addr;
    union tile bkg_tile;
    //union tile win_tile;
    ...
    bkg_tile.attr.palette++;
    
    set_vram_byte(bkg_tile_addr, bkg_tile._tile);
    VBK_REG = VBK_BANK_0;
}

void decrementBkgTileColor(SCRIPT_CTX * THIS) OLDCALL BANKED {
    THIS;
    uint8_t * bkg_tile_addr;
    union tile bkg_tile;
    //union tile win_tile;
...
void flipBkgTileX(SCRIPT_CTX * THIS) OLDCALL BANKED {
    THIS;
    uint8_t * bkg_tile_addr;
    union tile bkg_tile;
    //union tile win_tile;
...
void flipBkgTileY(SCRIPT_CTX * THIS) OLDCALL BANKED {
    THIS;
    uint8_t * bkg_tile_addr;
    union tile bkg_tile;
    //union tile win_tile;
